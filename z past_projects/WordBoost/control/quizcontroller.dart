...
import 'package:wordup/view/QuizStatisticsPage.dart';
import 'package:wordup/view/quizbuttonspage.dart';
...
class QuizController extends GetxController
  ...
  void onInit() {
    ...
    highestStreak = dbController.statistics[0]['highest_streak'];
    initButtons();
    firstFiveInite();
    // if (dbWords.length < 5) {
  ...
  void initButtons() {
    for (int i = enAvailable.length;
      ...
      if (indx < dbWords.length) {
        _enWords[enAvailable[0]] = dbWords[indx]['english'];
        _arWords[arAvailable[0]] = dbWords[indx]['arabic'];
  ...
  void checkAnswer() async {
    if (correctAnswers[enChoice] == arChoice) {
      ...
      dbController.editPlusReview(enShown[enChoice]);
      correct.value++;
      streak.value++;
